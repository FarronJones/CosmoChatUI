...
// Import the profile photo for Farron
import FarronProfilePhoto from './Farron.png';
    ...
    <div className="App">
      ...
      <div style={{ position: "relative", height: "800px", width: "700px" }}>
        <MainContainer>
              ...
              {messages.map((message, i) => (
                <Message
                  ...
                  model={{
                    ...
                    avatarSrc: message.sender === "Farron" ? FarronProfilePhoto : null
                  }}
                />
              ))}
            </MessageList>
         ...
         {/* Position FarronProfilePhoto */}
         <img src={FarronProfilePhoto} alt="Farron" style={{ position: 'absolute', top: '20px', right: '20px', width: '50px', height: '50px', borderRadius: '50%' }} />
      </div>
